...
const Login = () => {
  ...
  const from = (location.state as { from?: { pathname: string } })?.from?.pathname || "/minha-conta";
  ...
  return (
    <main className="flex-1 pt-24 pb-16 flex items-center justify-center bg-muted/30">
