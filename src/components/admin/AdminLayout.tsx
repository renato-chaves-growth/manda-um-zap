...
const navItems = [
  ...
  { to: "/admin/receita", label: "Receita", icon: DollarSign },
      ...
      <div className="container">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-xl bg-[#1B2B2A] flex items-center justify-center">
              <LayoutDashboard className="w-5 h-5 text-white" />
            </div>
            <div>
              <h1 className="text-lg font-bold text-foreground">Painel Administrativo</h1>
              <p className="text-sm text-muted-foreground">MandaUmZap</p>
            </div>
          </div>
              ...
              return (
                <NavLink
                  ...
                  className={cn(
                    ...
                    isActive
                      ? "bg-[#1B2B2A] text-white shadow-md"
        ...
        <div className="flex gap-6">
          ...
          {!isMobile && (
            <aside className="w-64 shrink-0">
              <div className="sticky top-24 space-y-1 bg-[#1B2B2A] rounded-2xl p-3">
                {navItems.map((item) => {
                  const isActive = location.pathname === item.to;
                  return (
                    <NavLink
