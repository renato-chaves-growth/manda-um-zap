...
const acquisitionOptions: AcquisitionOption[] = [
  {
    id: "individual",
    icon: Users,
    title: "Começar com 1 agente",
    subtitle: "Escolha o que resolve sua maior dor agora",
    price: "R$ 29,00",
    priceNote: "/mês por agente",
    features: [
      "Ative só o agente que precisar",
      "Cada agente resolve uma dor específica",
      "Pause ou troque quando quiser",
      "Ideal para começar sem risco",
    ],
  ...
  },
  {
    id: "integrated",
    icon: Zap,
    title: "Time completo (5 agentes)",
    subtitle: "Automação de ponta a ponta no seu negócio",
    price: "R$ 145,00",
    priceNote: "/mês · todos os 5 agentes",
    features: [
      "Clara + Otávio + Lucas + Helena + Maya",
      "Do primeiro contato até o pagamento",
      "Atendimento, orçamento, agenda e financeiro",
      "Divulgação no Instagram no automático",
    ],
    cta: "Quero o time completo",
    ctaLink: "/carrinho?agentes=clara,otavio,lucas,helena,maya",
    highlight: true,
  },
];
