...
import { UserPlus, Settings2, MessageCircle, ArrowRight } from "lucide-react";
...
/**
 * HowItWorksSection — 3 passos para começar a usar o MandaUmZap.
 */
      ...
      <div className="container max-w-5xl">
        ...
        >
          <h2
            ...
            className="text-3xl md:text-4xl lg:text-5xl font-light text-foreground mb-4 tracking-tight"
          >
            Como{" "}
            <span
        ...
        {/* Passos — coluna no mobile, linha no desktop */}
        <ol className="grid gap-4 md:gap-6 md:grid-cols-3 mb-12 md:mb-16 list-none">
          {STEPS.map((step, index) => (
            ...
            >
              ...
              {/* Seta de conexão entre passos — apenas desktop */}
              {index < STEPS.length - 1 && (
                <div
                  className="hidden md:flex absolute top-1/2 -right-3 lg:-right-4 -translate-y-1/2 z-10"
                  aria-hidden="true"
                >
